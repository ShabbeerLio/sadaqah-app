...
const Adhan = () => {
  ...
  useEffect(() => {
    if (!selectedMasjid?.adhanTimes) return;

    const adhanTimes = selectedMasjid.adhanTimes;

    // Pick only relevant prayers
    const prayers = [
      { name: "Fajr", time: adhanTimes.Fajr },
      { name: "Dhuhr", time: adhanTimes.Dhuhr },
      { name: "Asr", time: adhanTimes.Asr },
      { name: "Maghrib", time: adhanTimes.Maghrib },
      { name: "Isha", time: adhanTimes.Isha },
    ];
              ...
              <div className="Collection-box-left adhaz-box">
                <div className="adhan-left">
                  ...
                  <h2>
                    {nextPrayer ? (
                      <>
                        ...
                        <span>
                          {" "}
                          {formatTo12Hour(nextPrayer.time).split(" ")[1]}
                        </span>
                  ...
                  <p className="adhan-sunrise">
                    <CalendarDays />
                    {date
                      ? `${date.hijri.day} ${hijriMonthNames[date.hijri.month]
                      } ${date.hijri.year} AH`
                      : ""}
                  </p>
                  ...
                  <div className="next-prayer">
                    ...
                    <div className="next-time">
                      <p> <Link to="/adhan">{selectedMasjid?.userName}</Link></p>
