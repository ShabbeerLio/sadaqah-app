...
const ZakatPayment = () => {
  ...
  const handlePay = () => {
    ...
    localStorage.setItem(
      userKey,
      JSON.stringify([...existingUserZakat, userZakat])
    );
    ...
    const existingReceived =
      JSON.parse(localStorage.getItem("zakatReceived")) || [];
    localStorage.setItem(
      "zakatReceived",
      JSON.stringify([...existingReceived, receivedZakat])
    );
  ...
  return (
    <div className="sadaqah-container">
      ...
      <div className="profile-header" style={{ marginTop: "1rem" }}>
